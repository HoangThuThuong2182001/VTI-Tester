...
CREATE TABLE `categoryquestion` (
  ...
  `CategoryName` enum('Java','.NET','SQL','Postman','Ruby') DEFAULT NULL,
...
--
-- Table structure for table `groupaaccount`
--

DROP TABLE IF EXISTS `groupaaccount`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `groupaaccount` (
...
--
-- Dumping data for table `groupaaccount`
--

LOCK TABLES `groupaaccount` WRITE;
/*!40000 ALTER TABLE `groupaaccount` DISABLE KEYS */;
/*!40000 ALTER TABLE `groupaaccount` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-29 10:45:26
